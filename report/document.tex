\documentclass[12pt,a4paper,natbib]{apa6}
...
To limit the scope of the project and allow for comparisons, we will focus on finding results for the problem on a standard board (8x8 squares).
...
The following two methods are available (sources still to be found/added):
\begin{itemize}
...
This is because this code is run once, and that is the result in the Table~\ref{tab:performance}.
...
\begin{lstlisting}[caption={Knight's tour multi-shot solving},label={lst:lstlisting}]

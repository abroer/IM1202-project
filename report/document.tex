...
%Here, we can see how adding rules can affect performance without affecting the final result. (We had two rules that did the same thing; adding both improved performance significantly.)

% we hebben ook nog deze feedback: Sommige aspecten van de onderzoeksvraag (bv. mbt de grootte van het bord) worden nog niet behandeld in het verslag. Zullen we deze onderzoeksvraag vervangen door dit topic?

...
The code used for testing and implementing the algorithms can be found in our project repository \cite{IM1202project}.
...
The first method takes 31.880 seconds to do this, while the second method takes 0.342 seconds.
...
\subsection{Adding rules for improvement of the performance}\label{subsec:adding-rules-for-improvement-of-the-performance}
...
The performance of both constraints was tested.
The performance of adding both constraints to the program was also tested.
All the results are shown in Table~\ref{tab:method}.
...
\subsection{Adding rules for improvement of the performance}\label{subsec:disc-adding-rules-for-improvement-of-the-performance}
...
The researched methods in this report showed a significant performance decrease when heuristics were applied due to the additional calculations needed.
